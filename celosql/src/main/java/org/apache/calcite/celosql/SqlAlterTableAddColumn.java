 ...
 */
public class SqlAlterTableAddColumn extends AbstractSqlAlterTable {
  /** */
  ...
  /** */
  public SqlAlterTableAddColumn(SqlParserPos pos, boolean ifExists, SqlIdentifier tblName,
