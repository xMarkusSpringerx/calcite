...
public class SqlIntervalTypeNameSpec extends SqlTypeNameSpec {
  /** */
  private final SqlIntervalQualifier sqlIntervalQualifier;

  /** Constructor. */
  public SqlIntervalTypeNameSpec(SqlIntervalQualifier intervalQualifier, SqlParserPos pos) {
  ...
  @Override public boolean equalsDeep(SqlTypeNameSpec spec, Litmus litmus) {
    if (!(spec instanceof SqlIntervalTypeNameSpec))
      return false;

    SqlIntervalTypeNameSpec that = (SqlIntervalTypeNameSpec)spec;
