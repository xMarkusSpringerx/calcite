 ...
 */
public abstract class AbstractSqlAlterTable extends SqlDdl {
  /** */
  ...
  /** */
  protected AbstractSqlAlterTable(SqlParserPos pos, boolean ifExists, SqlIdentifier tblName) {
    super(OPERATOR, pos);
    this.ifExists = ifExists;
    name = requireNonNull(tblName, "table name");
  }
