 ...
 */
public class SqlAlterTableDropColumn extends AbstractSqlAlterTable {
  /** */
  ...
  /** */
  public SqlAlterTableDropColumn(SqlParserPos pos, boolean ifExists, SqlIdentifier tblName,
